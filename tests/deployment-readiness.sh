...
assert_contains "$repo_root/docs/phase2-boundaries.md" 'First ntfy live-send validation.*PARTIAL'
assert_contains "$repo_root/docs/phase2-boundaries.md" 'ntfy receipt diagnostic gate'
assert_contains "$repo_root/docs/phase2-boundaries.md" 'No further Hermes service sends'
assert_contains "$repo_root/docs/phase2-boundaries.md" 'rotate to a fresh high-entropy topic'
assert_contains "$repo_root/docs/phase2-boundaries.md" 'secrets.token_urlsafe'
...
assert_contains "$repo_root/system/nixos/harness.nix" 'EnvironmentFile = "-/var/lib/hermes/delivery/ntfy.env";'
