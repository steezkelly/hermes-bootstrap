...
assert_contains "$repo_root/docs/phase2-boundaries.md" 'no timer should be added'
...
assert_contains "$repo_root/system/nixos/harness.nix" 'ReadWritePaths = lib\.mkForce \[ "/var/lib/hermes/delivery/state" \];'
