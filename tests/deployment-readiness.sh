...
assert_contains "$repo_root/docs/phase2-boundaries.md" 'ack_critical_alert\.py'
assert_contains "$repo_root/docs/phase2-boundaries.md" 'Future critical-alert live-send design gate'
assert_contains "$repo_root/docs/phase2-boundaries.md" '[Oo]ne-send validation budget'
assert_contains "$repo_root/docs/phase2-boundaries.md" 'Steve decision boundary'
assert_contains "$repo_root/scripts/harness/ack_critical_alert.py" 'No message was sent\.'
assert_not_contains "$repo_root/scripts/harness/ack_critical_alert.py" 'urllib|smtplib|HERMES_DELIVERY_NTFY_TOPIC|/var/lib/hermes/secrets/hermes\.env|journalctl'
