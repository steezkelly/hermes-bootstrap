...
The script mounts the target partitions, copies the flake to `/mnt/etc/nixos/flake.nix`, creates a placeholder credential file if needed, and runs the known-good flake path:
