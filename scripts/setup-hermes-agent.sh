...
echo ""
echo "Next steps:"
echo "  1. Run: sudo ./scripts/deploy-hermes.sh --prepare-usb /dev/sdX"
echo "  2. Boot target from USB"
echo "  3. Run: sudo ./scripts/deploy-hermes.sh --all /dev/sdX /dev/nvme0n1"
echo ""
