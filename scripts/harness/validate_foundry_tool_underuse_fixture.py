#!/usr/bin/env python3
"""Thin bootstrap boundary validator for Foundry tool-underuse fixture output.

Validates ONLY mechanical file-existence, JSON parse, schema_version, and
external-writes safety. Does NOT evaluate tool-call semantics or verdicts.
"""
...
def main() -> int:
    if len(sys.argv) != 2:
        print("Usage: validate_foundry_tool_underuse_fixture.py <output-dir>", file=sys.stderr)
        return 2
